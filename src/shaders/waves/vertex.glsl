...
// to apply more noise at higher freq, we can change the elevation by inc freq and dec amplitude based on each iteration
// brought in more uniforms for small waves to adjust freq, speed and iterations for debug
// more iterations => more perceived detail
